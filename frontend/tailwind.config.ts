  ...
  theme: {
    ...
    extend: {
      ...
      colors: {
        ...
        trace: { DEFAULT: "hsl(var(--trace))", soft: "hsl(var(--trace-soft))" },
      ...
      boxShadow: { soft: "var(--shadow-soft)", glow: "var(--shadow-glow)" },
      backgroundImage: { primary: "var(--gradient-primary)", panel: "var(--gradient-panel)", app: "var(--gradient-app)" },
      keyframes: {
        "accordion-down": { from: { height: "0" }, to: { height: "var(--radix-accordion-content-height)" } },
        "accordion-up": { from: { height: "var(--radix-accordion-content-height)" }, to: { height: "0" } },
        "trace-pulse": { "0%,100%": { opacity: ".35", transform: "scale(.96)" }, "50%": { opacity: "1", transform: "scale(1.05)" } },
        "enter-up": { from: { opacity: "0", transform: "translateY(16px)" }, to: { opacity: "1", transform: "translateY(0)" } },
      },
      animation: { "accordion-down": "accordion-down 0.2s ease-out", "accordion-up": "accordion-up 0.2s ease-out", "trace-pulse": "trace-pulse 2.2s ease-in-out infinite", "enter-up": "enter-up .45s ease-out both" },
    },
  },
